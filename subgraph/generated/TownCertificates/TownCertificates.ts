...
export class TownCertificates extends ethereum.SmartContract {
  static bind(address: Address): TownCertificates {
    return new TownCertificates("TownCertificates", address);
  }
